...
<?php include('../includes/navbar.php'); ?>
    ...
    <div class="car-container">
        ...
        <div class="cars">
            ...
            require_once '../controllers/lamborghini.php';

            // Instantiate the controller and fetch the car details
            $lamborghiniController = new LamborghiniController();
            $cars = $lamborghiniController->getLamborghiniCars(); // Get the list of Lamborghini cars
            ...
            if (!empty($cars)) {
                ...
                echo '<p>No Lamborghini cars found in the database.</p>';
            }
            ?>
        </div>
    </div>
