...
<?php include('../includes/navbar.php'); ?>
    ...
    <div class="car-container">
        <h1>Range Rover Cars</h1>
        <div class="cars">
            <?php
            // Include the controller to fetch the car data
            require_once '../controllers/rangerovercontroller.php';

            // Instantiate the controller and fetch the car details
            $rangeRoverController = new RangeRoverController();
            $cars = $rangeRoverController->getRangeRoverCars(); // Get the list of Range Rover cars
            ...
            if (!empty($cars)) {
                ...
                echo '<p>No Range Rover cars found in the database.</p>';
            }
            ?>
        </div>
    </div>
