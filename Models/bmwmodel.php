...
class BmwModel {
    ...
    // Method to fetch BMW car details (manufacture_year, price, img, model)
    public function getBmwCars() {
        // Database connection from the Database class
        $conn = $this->db->getConnection();

        // SQL query to get data from the 'bmw' table, including 'model' column
        $query = "SELECT manufacture_year, price, img, model FROM bmw";
