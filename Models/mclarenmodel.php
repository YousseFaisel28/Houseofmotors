...
class McLarenModel {
    ...
    // Method to fetch McLaren car details (manufacture_year, price, img, model)
    public function getMcLarenCars() {
        // Database connection from the Database class
        $conn = $this->db->getConnection();

        // SQL query to get data from the 'mclaren' table, including 'model' column
        $query = "SELECT manufacture_year, price, img, model FROM mclaren";
